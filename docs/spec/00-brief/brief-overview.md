...
> **대상**: 팀장 · 매니저 · 의사결정자.
> **목적**: 개발자용 Overview(아키텍처 표준 템플릿 arc42 v9.0)를 비개발자 관점으로 압축하여 비즈니스 가치, 시스템 경계, 위험, 아키텍처 결정 사항(ADR)만 정리합니다.
> **읽는 시간**: 약 10분. 기술 상세가 필요한 경우 본문 마지막의 개발자용 산출물을 참조해 주십시오.
...
세 목표는 brief.md(한장 브리핑)와 동일하며, 개발자용 Overview의 QG-1·QG-2·QG-3과 정확히 일치합니다. AIOpsAgent가 이 세 목표를 보장합니다.
...
| **팀장용 Use Case** | 시나리오 3종 (정상·실패·AI 다운) | [brief-usecase.html](brief-usecase.html) |
| **팀장용 기능명세** | 구성 요소 9개 요지 | [brief-spec.html](brief-spec.html) |
| **팀장용 WBS** | 작업 진행 상황·마일스톤 | [brief-wbs.html](brief-wbs.html) |
| **개발자용 Overview** | arc42 v9.0 전체 (아키텍처·품질 시나리오) | [../01-overview/overview.html](../01-overview/overview.html) |

본 개요는 개발자용 Overview를 비기술 청중에 맞춰 압축한 것입니다. 상세 내용이 필요한 부분은 위 링크를 참조해 주십시오.

---

> 본 산출물은 개발 디테일 없이도 의사결정에 필요한 정보만 담았습니다.
> 추가 문의는 [한장 브리핑](brief.html) 또는 [개발자용 Overview](../01-overview/overview.html) 참조.
