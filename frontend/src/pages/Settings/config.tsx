...
export const aiModuleSettings = (t: TFunction): RouteTabProps['routes'] => [
	{
		Component: AIModuleSettings,
		name: (
			<div className="periscope-tab">
				<Sparkles size={16} /> {t('routes:ai_module').toString()}
			</div>
		),
		route: ROUTES.AI_MODULE_SETTINGS,
