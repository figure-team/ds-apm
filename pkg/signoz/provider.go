...
func NewSQLMigrationProviderFactories(
	...
	return factory.MustNewNamedMap(
		...
		sqlmigration.NewAddDSRemediationFactory(sqlstore),
		sqlmigration.NewAddRemediationSourceFactory(sqlstore),
		sqlmigration.NewAddRemediationTargetFactory(sqlstore),
		...
		sqlmigration.NewAddCodebaseArtifactPathFactory(sqlstore),
	)
}
...
func NewAlertmanagerProviderFactories(sqlstore sqlstore.SQLStore, orgGetter organization.Getter, nfManager nfmanager.NotificationManager, aiHook *dispatchhook.Hook) factory.NamedMap[factory.ProviderFactory[alertmanager.Alertmanager, alertmanager.Config]] {
	return factory.MustNewNamedMap(
		signozalertmanager.NewFactory(sqlstore, orgGetter, nfManager, aiHook),
	)
}
