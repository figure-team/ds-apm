...
func TestNewHandlers(t *testing.T) {
	...
	handlers := NewHandlers(modules, providerSettings, nil, querierHandler, nil, nil, nil, nil, nil, nil, nil, registryHandler, alertmanager, nil, sqlstore, nil, nil, nil, nil, nil)
